...
public class testApevhAndOneShotAndThread implements Safelet<Mission> {
	...
	private static class TenThread extends Mission {
		...
		public void initialize() {
			MyAperiodicEvh aevh = new MyAperiodicEvh(new PriorityParameters(10),
					new AperiodicParameters(), testApevhAndOneShotAndThread.storageParameters_Handlers);
			...
			PeriodicEventHandler pevh = new MyPeriodicEvh(new PriorityParameters(50),
					...
					testApevhAndOneShotAndThread.storageParameters_Handlers, this, aevh);
		...
		private static class MyAperiodicEvh extends AperiodicEventHandler {
			...
			public void handleAsyncEvent() {
				...
				count++;
				if (count == 50) {
					testApevhAndOneShotAndThread.m.requestTermination();
					count = 0;
				}
			}
		}
	...
	public static void main(String[] args) {
		...
		new Launcher(new testApevhAndOneShotAndThread(), 1, true);
