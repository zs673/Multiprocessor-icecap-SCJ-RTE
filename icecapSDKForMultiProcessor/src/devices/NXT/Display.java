...
public class Display {
	...
	private static byte displayLineNumbers[][] = { { (byte) 0xB0, 0x10, 0x00 },
			{ (byte) 0xB1, 0x10, 0x00 }, { (byte) 0xB2, 0x10, 0x00 }, { (byte) 0xB3, 0x10, 0x00 },
			{ (byte) 0xB4, 0x10, 0x00 }, { (byte) 0xB5, 0x10, 0x00 }, { (byte) 0xB6, 0x10, 0x00 },
			{ (byte) 0xB7, 0x10, 0x00 } };
