...
public class AnnotationsAttribute extends Attribute {
	...
	public static AnnotationsAttribute getAttribute(RuntimeInvisibleAnnotations attribute) {
		AnnotationsAttribute aattr = new AnnotationsAttribute(attribute.getNameIndex(),
				attribute.getLength(), attribute.getConstantPool());
	...
	public <A extends Annotation> A getAnnotation(Class<A> annotationClass) {
		...
		return (A) Proxy.newProxyInstance(getClass().getClassLoader(),
