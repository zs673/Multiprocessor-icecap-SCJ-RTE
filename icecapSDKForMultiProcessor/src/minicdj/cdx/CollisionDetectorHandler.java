...
public class CollisionDetectorHandler extends PeriodicEventHandler {
	...
	public CollisionDetectorHandler(Mission mission) {
		...
		super(new PriorityParameters(Priorities.PR98), null, new StorageParameters(
				Constants.TRANSIENT_DETECTOR_SCOPE_SIZE, null, 0, 0, 0)); // HSO
	...
	public void handleAsyncEvent() {
		try {
			...
			devices.Console
					.println("CollisionDetectorHandler:Exception thrown by runDetectorInScope: "
							+ e.getMessage());
			e.printStackTrace();
		}
	}
