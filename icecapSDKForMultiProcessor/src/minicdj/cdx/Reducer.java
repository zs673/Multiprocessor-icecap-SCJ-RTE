...
class Reducer {
	...
	protected boolean isInVoxel(Vector2d voxel, Motion motion) {
		Benchmarker.set(9);
		if (voxel.x > Constants.MAX_X || voxel.x + voxel_size < Constants.MIN_X
				|| voxel.y > Constants.MAX_Y || voxel.y + voxel_size < Constants.MIN_Y) {
			Benchmarker.done(9);
			return false;
		}
	...
	protected void dfsVoxelHashRecurse(Motion motion, Vector2d next_voxel, HashMap voxel_map,
