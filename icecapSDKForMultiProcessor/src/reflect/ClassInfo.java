...
public abstract class ClassInfo extends HardwareObject {
	...
	private static class ObjectReferenceOffsetIterator implements ReferenceIterator {
	...
	private static class ArrayReferenceOffsetIterator implements ReferenceIterator {
